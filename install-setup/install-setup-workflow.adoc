...
NOTE: AI Data Engine(AIDE)과 함께 AFX 1K를 배포하는 경우 AFX 시스템 전원을 켠 후 AIDE 데이터 컴퓨팅 노드를 설치하십시오. 자세한 내용은 link:https://docs.netapp.com/us-en/ai-data-engine/install-setup/aide-hardware-requirements.html["AIDE 데이터 컴퓨팅 노드 설치"]을 참조하십시오.
