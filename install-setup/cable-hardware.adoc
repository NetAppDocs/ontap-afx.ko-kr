...
+
image::../media/drw_afx_ha_cluster_storage_a_ieops-2779.svg[케이블 컨트롤러 클러스터,HA,and storage to switch A]
...
+
image::../media/drw_afx_ha_cluster_storage_b_ieops-2780.svg[케이블 컨트롤러 클러스터,HA,and storage to switch B]
