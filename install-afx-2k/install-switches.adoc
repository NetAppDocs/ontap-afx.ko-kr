...
summary: AFX 2K 스토리지 시스템 및 스토리지 셸프용 스위치 설치 방법을 알아보세요. 
---
= AFX 2K 스토리지 시스템의 스위치를 설치합니다
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
AFX 2K 스토리지 시스템 설치 준비를 완료한 후에는 스위치를 캐비닛 또는 통신 랙에 설치해야 합니다.
...
NOTE: 스위치의 공기 흐름이 포트 측 흡기(버건디색 팬 및 전원 공급 장치)로 구성된 경우, 스위치의 네트워크 포트는 캐비닛 전면을 향하도록 설치해야 하며, 배기 팬은 캐비닛 후면을 향해야 합니다. 이 구성에서는 캐비닛 전면의 네트워크 포트에서 캐비닛 후면의 스토리지 포트까지 연결하기에 충분한 길이의 케이블을 사용해야 합니다. + 이러한 스위치에 대한 자세한 내용은 Cisco 웹사이트(link:https://www.cisco.com/c/en/us/td/docs/switches/datacenter/nexus9000/hw/9800/9808/nx-os/cisco-nexus-9808-nx-os-mode-switch-hardware-installation-guide/m-8000-modular-overview-ph2.html["Cisco Nexus 9808 Mode Switch 하드웨어 설치 가이드"^], link:https://www.cisco.com/c/en/us/td/docs/dcn/hw/nx-os/nexus9000/9332d-gx2b/cisco-nexus-9332d-gx2b-nx-os-mode-switch-hardware-installation-guide.html["Cisco Nexus 9332D-GX2B 모드 스위치 하드웨어 설치 가이드"^] 및 link:https://www.cisco.com/c/en/us/td/docs/dcn/hw/nx-os/nexus9000/9364d-gx2a/cisco-nexus-9364d-gx2a-nx-os-mode-switch-hardware-installation-guide.html["Cisco Nexus 9364D-GX2A 모드 스위치 하드웨어 설치 가이드"^])를 참조하십시오.
...
== Cisco Nexus 9808 스위치 설치

Cisco Nexus 9808 스위치를 설치하는 경우, 캐비닛 또는 랙에 스위치를 설치하는 방법에 대한 자세한 지침은 link:https://www.cisco.com/c/en/us/td/docs/switches/datacenter/nexus9000/hw/9800/9808/nx-os/cisco-nexus-9808-nx-os-mode-switch-hardware-installation-guide/m-8000-install-chassis.html["Cisco Nexus 9808 Mode Switch 하드웨어 설치 가이드"^]을 참조하십시오.



== Cisco Nexus 9332D-GX2B 및 9364D-GX2A 스위치 설치

Cisco Nexus 9332D-GX2B 또는 9364D를 설치하는 경우, 다음 단계를 따라 스위치를 캐비닛 또는 랙에 설치하십시오.
...
.. 패널 뒷면에서 나오는 두 점퍼 코드의 암 커넥터를 브러시 어셈블리를 통해 끼우십시오.
+
...
+
컨트롤러와 쉘프에 효율적으로 접근할 수 있는 캐비닛 위치(예: 중간 열)에 두 개의 스위치를 설치하십시오.
...
.다음은 무엇인가요?
캐비닛이나 랙에 스위치를 설치한 후에는 link:deploy-hardware.html["캐비닛 또는 랙에 AFX 2K 스토리지 시스템과 쉘프를 설치합니다."].
