...
[role="lead"]
AFX 2K 스토리지 시스템에 연결하는 각 네트워크에 필요한 정보를 기록합니다.
...
AFX 2K 스토리지 시스템 설치를 시작하기 전에 필요한 네트워크 정보를 준비하십시오.
...
Cisco Nexus 9808, Cisco Nexus 9332D-GX2 및 9364D-GX2A 스위치의 설치 및 유지 관리를 위해서는 케이블 및 네트워크 요구 사항을 반드시 검토하십시오.
...
.다음은 무엇인가요?
네트워크 요구 사항을 검토한 후, 귀하는 link:cable-hardware.html["AFX 2K 스토리지 시스템의 컨트롤러 및 스토리지 쉘프 케이블 연결"].
