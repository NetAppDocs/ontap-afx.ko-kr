...
NetApp AFX는 고성능 NAS 및 객체 워크로드에 최적화되어 있습니다. 따라서 AFF 및 FAS 스토리지 시스템과는 몇 가지 차이점이 있습니다. 다음 기능은 NetApp AFX에서 사용할 수 없으며, 목록은 주요 기능 또는 기능 영역별로 정리되어 있습니다. 또한 사용 중인 ONTAP 릴리스에 따라 link:../release-notes/whats-new-9171.html["새로운 소식"]에서 AFX의 업데이트 및 변경 사항을 검토해야 합니다.
